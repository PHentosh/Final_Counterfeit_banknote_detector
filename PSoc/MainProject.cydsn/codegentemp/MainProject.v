// ======================================================================
// MainProject.v generated from TopDesign.cysch
// 01/15/2022 at 05:41
...
module SCB_UART_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("89bada7d-5693-4311-84cd-1fd5081bb1d7/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
...
module CapSense_v3_0_1 ;
	...
	cy_clock_v1_0
		#(.id("c6744a8c-3b1c-4ca6-a721-76c280343821/8273f0d6-caef-4cc7-ad3c-09656b78e2cb"),
...
module Scan_ADC_v3_10_2 (
	...
	cy_clock_v1_0
		#(.id("e9196845-9825-41e0-8faa-2a8425c460a5/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpFB_0__LCD_RESET_N_net;
	wire [0:0] tmpIO_0__LCD_RESET_N_net;
	electrical [0:0] tmpSIOVREF__LCD_RESET_N_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LCD_RESET_N
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__LCD_RESET_N_net[0:0]}),
		  .io({tmpIO_0__LCD_RESET_N_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_RESET_N_net));
	...
	wire [0:0] tmpFB_0__UF_LED_net;
	wire [0:0] tmpIO_0__UF_LED_net;
	electrical [0:0] tmpSIOVREF__UF_LED_net;
	...
	cy_mxs40_gpio_v1_0
		...
		UF_LED
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__UF_LED_net[0:0]}),
		  .io({tmpIO_0__UF_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__UF_LED_net));
    ...
    GraphicLCDIntf_v1_80 GraphicLCDIntf_1 (
        .clock(Net_74),
        .d_c(Net_132),
        .di_lsb(Net_133[7:0]),
        .di_msb(8'b0),
        ...
        .nwr(Net_130),
        .oe(Net_127));
    defparam GraphicLCDIntf_1.BitWidth = 8;
    defparam GraphicLCDIntf_1.ReadHiPulse = 10;
    defparam GraphicLCDIntf_1.ReadLoPulse = 10;
